...
\subsection{Work Package 2 (WP2) Lattice QuantumChromoDynamics (QCD) and Quantum Information Theories}
...
\subsection{Work package 3 (WP3):Software for Quantum Simulations}
...
\end{figure}
 ...
 The time line for the development of the various elements WP3 is
\begin{footnotesize}
\begin{center}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|c|}
\hline
